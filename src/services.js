...
export const generateAuthCodeUrl = function () {
  var authURL =
...
export const getAccessToken = async (x) => {
...
export const copyGoogleDoc = async (token) => {
...
export const batchUpdate = async (doc_id, token) => {
